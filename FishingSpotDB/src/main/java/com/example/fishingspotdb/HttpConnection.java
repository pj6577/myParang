...
public class HttpConnection {
    public static JSONArray getJsonArray() {
        ...
        try {
            URL url = new URL("http://apis.data.go.kr/1192000/select0230List/getselect0230List?serviceKey=ibLbjUeflEbwvabQPhiiv42uitjDDNSJQ2GB%2Fm09S1QBaRkH1c5uhfE7fN8uFJC7xsxzgmwgSxqhn52PLXsz7w%3D%3D&numOfRows=10&pageNo=2&type=JSON");
